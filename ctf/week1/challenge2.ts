...
const mint = new PublicKey("AG14JQYn5QRX4UqvUro1qENUivmoW9P2Z6a9h9obiaXj");
...
(async () => {
    try {
        ...
        // Mint some tokens! 2 whole tokens with 6 decimal places
        ...
        // https://explorer.solana.com/tx/4vhWajKHpenXwFQMgHCpKQgQCSd9tc9Fm2kr3xyNZwxgEuh6DSJfkwQAKkQvGLQmrWABEZg1M6fDVjYEHc6roLw1?cluster=devnet

        // Sending 255 decimal token to vault
        console.log(`Send 255 decimal of a token to this vault: 
        https://explorer.solana.com/address/${vault.toBase58()}?cluster=devnet`);

        // https://explorer.solana.com/address/FWBBEfSkkUPF1k6e79bcK4px9urQhqTYzrqxFP8wx3cS?cluster=devnet
        ...
        // https://explorer.solana.com/tx/46RNGeLYhNpgUhK6Gu1y4ssxxLdWVaTs6b1UnL2tS1NP6rFNc9jdj1UXZe6SuaGNUeYNijzvhhYpYFiUbTpDA4RZ?cluster=devnet
